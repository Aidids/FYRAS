...
<div class="modal fade" id="editProfile" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <form class="forms" action="../BACK_END/update_profile.php" method="POST">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <ul class="nav submenu-wrapper">
              <!-- <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#AddData" aria-expanded="false" aria-controls="AddData">
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="tables">
                  <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="list_supervisor">User</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="list_students">Student</a>
                    </li>
                    <!-- <li class="nav-item">
                      <a class="nav-link" href="list_res_project.php">Research Project</a>
                    </li> -->
                    <li class="nav-item">
                      <a class="nav-link" href="list_programme">Programme</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="list_foe">Field of Expertise</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="list_certificate">Certificate</a>
                    </li>
                    <!-- <li class="nav-item"> <a class="nav-link" href="../../dashboard_plugin/demo/vertical-fixed/pages/tables/js-grid.html">Js-grid</a></li> -->
                  </ul>
                </div>
              </li>
            </ul>
              ...
              <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                  <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> 
                      <a class="nav-link" onclick="showSwal('warning-message-and-cancel')" href="../BACK_END/logout.php">
