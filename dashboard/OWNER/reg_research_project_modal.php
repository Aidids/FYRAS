        ...
        <form action="../BACK_END/reg_research_project.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label>Reserach Project Name</label>
                    <input type="text" class="form-control" name="reg_rp_name" required="required"/>
                </div>

                <div class="form-group">
                    <label>Description</label>
                    <input type="text" class="form-control" name="reg_rp_description"/>
                </div>
