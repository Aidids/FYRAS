        ...
        <div class="content-wrapper">
          ...
          <div class="row mt-3">
            <div class="col-12 col-sm-6 col-md-6 col-xl-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 class="display-4" style="font-weight: heavy; color: blue;">Supervisor Quantity</h2>
                  <?php
                    $sql = $db->query("SELECT COUNT(USER_ID) AS SUPERVISOR_QTY FROM USER_ACCOUNT WHERE USER_CATEGORY = 'SUPERVISOR'");
                    $sql->execute();

                    $row = $sql->fetch(PDO::FETCH_ASSOC);
                  ?>
                  <br/>
                  <h2><?php echo $row["SUPERVISOR_QTY"];?></h2>
                </div>
              </div>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-xl-3 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h2 h2 class="display-4" style="font-weight: heavy; color: blue;">Student Quantity</h2>
                  <?php
