                ...
                <div class="col-12">
                  <div class="table-responsive table-striped">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php
                          $rpStmt = $db->query("SELECT DISTINCT(RP.PROJECT_ID) AS PROJECT_ID, RP.PROJECT_TITLE, RP.PROJECT_DESCRIPTION, RP.PROJECT_SUBMISSION_DATE, 
                        ...
                        <tr>
                            ...
                            <td><?php echo date('Y',strtotime($rpRow['PROJECT_SUBMISSION_DATE']));//echo $rpRow['STUD_NAME']; ?></td>                            
